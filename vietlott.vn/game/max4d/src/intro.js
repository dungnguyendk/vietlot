...
var Intro = (function () {
    ...
    Intro.prototype.create = function () {
        var bg = this.game.add.sprite(0, 0, Resources.bg_main.name);
    ...
    Intro.prototype.talk1 = function () {
        ...
        talkGroup.add(this.game.add.sprite(90, 200, Resources.bg_talk.name));
        talkGroup.add(this.game.add.sprite(570, 280, Resources.ico_arrow.name));
        var style = { font: "25px Arial", fill: "#000000", wordWrap: true, wordWrapWidth: 800, align: "center", boundsAlignH: 'center', boundsAlignV: 'center' };
        ...
        var callback = function () {
            ...
            var btnRule = _this.game.add.button(222, 365, Resources.btn_help.name, function () {
                OpenRule(1);
            });
        ...
        this.runningText(talkTxt, 'Quý khách muốn chơi ngay hay tìm\nhiểu luật chơi Xổ Số tự chọn Max 4D', callback);
    };
    Intro.prototype.talk2 = function () {
        var _this = this;
        var groupChoseNumber = this.game.add.group();
        var btnChooseNumber = this.game.add.button(340, 324, Resources.btn_choose_number.name, function () {
